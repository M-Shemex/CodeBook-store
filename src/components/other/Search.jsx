...
export const Search = () => {
  ...
  function search(event) {
    ...
    if (inputValue) {
      navigate(`/products?q=${input.current.value}`);
    }
  }
  return (
    <div className="mx-auto max-w-screen-xl p-2 my-5">
      ...
      >
        <div className="relative w-full">
          <span className=" bi bi-search flex absolute inset-y-0 left-0 items-center dark:text-white pl-3 pointer-events-none"></span>
          <input
            ref={input}
            name="search"
            type="text"
